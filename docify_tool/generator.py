...
def generate_readme(project_context, api_key):
    ...
    prompt_template = ChatPromptTemplate.from_template(
        ...
        "Based on the following complete project context, which includes file paths and their contents, generate an attractive and dynamic README.md file in markdown format.\n\n"
    ...
    # --- CHANGE HERE ---
    # Initialize the Gemini model and explicitly pass the API key.
    llm = ChatGoogleGenerativeAI(model="gemini-2.5-flash", google_api_key=api_key)
    
    chain = prompt_template | llm | StrOutputParser()
    
    print("🤖 AI (Gemini) is analyzing the project and writing the README...")
